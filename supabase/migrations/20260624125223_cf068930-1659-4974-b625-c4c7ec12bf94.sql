...
DROP FUNCTION IF EXISTS public.admin_editar_movimiento(uuid, public.tipo_mov_t, date, uuid, uuid, uuid, numeric, integer, integer, text, text, uuid, text, text, text);
DROP FUNCTION IF EXISTS public.admin_editar_movimiento(uuid, public.tipo_mov_t, date, uuid, uuid, uuid, numeric, integer, integer, text, text, uuid, text, text, text, uuid);
DROP FUNCTION IF EXISTS public.registrar_movimiento(public.tipo_mov_t, uuid, numeric, uuid, uuid, uuid, text, text, text, date, text, text, integer, integer);
DROP FUNCTION IF EXISTS public.registrar_movimiento(public.tipo_mov_t, uuid, numeric, uuid, uuid, uuid, text, text, text, date, text, text, integer, integer, uuid);
...
REVOKE ALL ON FUNCTION public.registrar_movimiento(public.tipo_mov_t, uuid, numeric, uuid, uuid, uuid, text, text, text, date, text, text, integer, integer, uuid, boolean) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.registrar_movimiento(public.tipo_mov_t, uuid, numeric, uuid, uuid, uuid, text, text, text, date, text, text, integer, integer, uuid, boolean) TO authenticated, service_role;

REVOKE ALL ON FUNCTION public.admin_editar_movimiento(uuid, public.tipo_mov_t, date, uuid, uuid, uuid, numeric, integer, integer, text, text, uuid, text, text, text, uuid, boolean) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.admin_editar_movimiento(uuid, public.tipo_mov_t, date, uuid, uuid, uuid, numeric, integer, integer, text, text, uuid, text, text, text, uuid, boolean) TO authenticated, service_role;