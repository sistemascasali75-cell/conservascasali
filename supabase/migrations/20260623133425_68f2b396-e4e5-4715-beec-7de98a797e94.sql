...
ALTER TABLE public.movimientos ADD COLUMN IF NOT EXISTS latas integer;
ALTER TABLE public.movimientos ADD CONSTRAINT movimientos_latas_nonneg CHECK (latas IS NULL OR latas >= 0);
